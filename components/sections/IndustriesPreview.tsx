  ...
  return (
    <section className={styles.section} aria-labelledby="industries-heading">
      <div className={styles.container}>
        ...
        <h2 id="industries-heading" className={styles.title}>Industries We Serve</h2>
        <p className={styles.description}>
          From homes to hospitals, farms to factories — we deliver engineering solutions tailored to every sector.
        </p>

        <div className={styles.grid}>
          {preview.map((industry) => {
            const Icon = (Icons[industry.icon as keyof typeof Icons] as Icons.LucideIcon) || Icons.Building2;
            return (
              <Link
                key={industry.id}
