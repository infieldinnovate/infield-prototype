...
import { Download as DownloadIcon, FileText, FileBadge, File } from 'lucide-react';
...
export function DownloadCard({ download, index = 0 }: DownloadCardProps) {
  const Icon = (Icons[download.icon as keyof typeof Icons] as React.ComponentType<{
    size?: number;
    strokeWidth?: number;
  }>) || FileText;
  ...
  return (
    ...
    >
      <div className={styles.topRow}>
        <div className={styles.iconWrapper} style={{ background: `${fileTypeColor}15`, color: fileTypeColor }}>
