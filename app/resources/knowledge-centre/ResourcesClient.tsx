        ...
        <div className={styles.container}>
          ...
          >
            ...
            <div className={styles.heroActions}>
              <LinkButton href="/resources/downloads" leftIcon={Download}>
                Download Company Profile
              </LinkButton>
              <LinkButton href="/quote" variant="outline" leftIcon={FileText}>
                Request Quote
              </LinkButton>
        ...
        <section className={styles.section}>
          <div className={styles.container}>
            <div className={styles.downloadsCta}>
              ...
              <LinkButton href="/resources/downloads" rightIcon={ArrowRight}>
                Browse Downloads
              </LinkButton>
            </div>
          </div>
